...
class UserController {
  ...
  async getContacts(req, res, next) {
    try {
      const userId = "694d22eeacc8296c7e246b33";
  ...
  async createContact(req, res, next) {
    try {
      ...
      if (existingContact) throw BaseError.BadRequest("Contact already exist");
      ...
      return res
        .status(201)
        .json({ message: "Contact added successfuly", contact: addedContact });
    } catch (error) {
      next(error);
    }
  }
